...
The **confusion matrix** is the most actionable output. Each row is a true class; each column is a predicted class. Perfect classification puts all mass on the diagonal. Off-diagonal cells reveal *which specific class pairs* get confused — pointing directly at where to focus next.
